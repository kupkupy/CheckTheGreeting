...
class NewPhrasesView: UIView {
    ...
    private lazy var label: UILabel = {
        let label = UILabel()
        label.text = "Новое выражение"
        label.font = UIFont(name: "FuturaPT-Medium", size: 18)
...
#warning("размер шрифта и тип шрифта плэйсхолдера не изменился")
        textField.attributedPlaceholder = NSAttributedString(string: "Название", attributes: [NSAttributedString.Key.foregroundColor: UIColor.systemGray4, NSAttributedString.Key.font: UIFont(name: "FuturaPT-Book", size: 40) as Any, NSAttributedString.Key.kern: -0.5])
...
extension NewPhrasesView: UIComponentsFactory { }
